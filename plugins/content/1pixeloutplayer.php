...
// Generic player instance function (returns object tag code)
	...
	$res = '<span class="onepixelout"><object type="application/x-shockwave-flash" data="'. JURI::base() .'plugins/content/1pixelout/player.swf" id="audioplayer'.$ap_playerID.'" height="24" width="290">
