<?php
/**
 * @version		$Id: form.php 308 2010-01-13 19:17:56Z joomlaworks $
 * @package		K2
...
<script type="text/javascript">
	...
	window.addEvent('domready', function(){
			...
			new Ajax(url, {
				...
				onComplete: function(res){
					...
					if (jsonResponse.status=="success"){
						var option = new Element('option',{'value':jsonResponse.name}).setHTML(jsonResponse.name).injectInside($('tags'));		
					}
					(function(){
		...
		$('browseSrv').addEvent('click', function(e){
			...
			SqueezeBox.fromElement(this, {
				handler: 'iframe',
				url: '<?php echo JURI::base()?>index.php?option=com_media&view=images&tmpl=component&e_name=existingImage',
				size: {x: 590, y: 400}
			});
		});
	...
	function jInsertEditorText( text, editor ) {
		if (editor=='existingImage'){
			$('existingImage').setHTML(text);
			var src = $$('#existingImage img').getProperty('src');
			$('existingImageValue').setProperty('value', src);
		}
...
<form action="index.php" enctype="multipart/form-data" method="post" name="adminForm" id="adminForm">
	...
	<div class="k2Frontend">
		  ...
		  <div id="k2FrontendEditToolbar">
		  	<h2 class="header icon-48-generic"><?php echo (JRequest::getInt('cid')) ? JText::_('Edit Item') : JText::_('Add Item'); ?></h2>
		  </div>
			    ...
			    <tr>
			      <td valign="top">
			          ...
			          <ul class="simpleTabsNavigation">
			            ...
			            <?php endif; ?>
			            <?php if(count($this->K2PluginsItemOther) && implode('',$this->K2PluginsItemOther) && $this->params->get('showK2Plugins')): ?>
			            ...
			            <table class="admintable">
			              <tr>
			                ...
			                <td><input type="file" name="image" class="text_area" />
			                  ...
			                  <span id="existingImage" style="display:none;"></span>
			          ...
			          <div class="simpleTabsContent">
			            ...
			            <dl id="system-message">
			              ...
			              <dd class="notice message fade">
			                <ul>
			                  <li><?php echo JText::_('Notice: Please install the Simple Image Gallery (Free/Pro) plugin if you want to use the image gallery features of K2!');?></li>
			                </ul>
			              </dd>
			            </dl>
			            <?php endif;?>
			          ...
			          <div class="simpleTabsContent">
			            ...
			            <table class="admintable" id="item_video_content">
			              <tr>
			                <td align="right" class="key"><?php echo JText::_('Video'); ?></td>
			                <td>
			                  ...
			                  <div class="panel" id="Video_from_provider"> <?php echo JText::_('Select video provider'); ?> <?php echo $this->lists['providers']; ?>
			                  	<br />
			                  	<?php echo JText::_('and enter video ID:'); ?> <input type="text" name="videoID" value="<?php echo $this->lists['providerVideo'] ?>" />
			                    <br />
			                    <br />
			                    <a target="_blank" href="http://www.joomlaworks.gr/content/view/35/41/"><?php echo JText::_('Read the AllVideos documentation for more...'); ?></a>
			                  </div>
			                  <?php echo $pane->endPanel();?>
			                  <?php echo $pane->startPanel(JText::_('Embed video'), 'vidtab4'); ?>
			              ...
			              <tr>
			                ...
			                <td><?php echo $this->row->video; ?>
			                  <input type="checkbox" name="del_video" id="del_video" />
			                  <label for="del_video"><?php echo JText::_('Use the form above to replace the existing video or check this box to delete current video'); ?></label></td>
			              </tr>
			              <?php endif;?>
			            </table>
			            <?php else:?>
			            <dl id="system-message">
			              ...
			              <dd class="notice message fade">
			                <ul>
			                  <li><?php echo JText::_('Notice: Please install the AllVideos plugin if you want to use the video features of K2!'); ?></li>
			                </ul>
			              </dd>
			            </dl>
				      		<table class="admintable" id="item_video_content">
