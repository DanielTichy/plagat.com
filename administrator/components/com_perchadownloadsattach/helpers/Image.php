...
class SimpleImage {
   ...
   function save($filename, $image_type=IMAGETYPE_JPEG, $compression=90, $permissions=null) {
      echo "<br> IMAGECLASS save ".$filename;
      ...
      if( $permissions != null) {
         chmod($filename,$permissions);
           echo "<br> IMAGECLASS chmod ".$filename." permision:".$permissions;
      }
   }
   ...
   function resize($width,$height) {
      ...
      echo "<br> IMAGECLASS RESIZE width".$width;
      echo "<br> IMAGECLASS RESIZE height".$height;
   ...
   function crop($top, $left, $width, $height)
   {
      ...
      //imagecopyresampled($new_image, $this->image, 0, 0, ($left-($width/2)) , ($top-($height/2)),  $width, $height, $this->getWidth(), $this->getHeight());
