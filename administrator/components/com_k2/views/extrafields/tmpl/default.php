  ...
  <table class="adminlist">
    <thead>
      <tr>
        ...
        <th><?php echo JHTML::_('grid.sort',   JText::_('Group'), 'groupname', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
        <th width="100">
	        <?php echo JHTML::_('grid.sort', JText::_('Order'), 'ordering', @$this->lists['order_Dir'], @$this->lists['order']); ?> <?php if ($ordering) echo JHTML::_('grid.order',  $this->rows ); ?>
        </th>
        <th><?php echo JHTML::_('grid.sort', JText::_('Published'), 'published', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
        <th><?php echo JHTML::_('grid.sort', JText::_('ID'), 'exf.id', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
      </tr>
    </thead>
    <tfoot>
      <tr>
