  ...
  <table class="adminlist">
		<thead>
			<tr>
				...
				<th><?php echo JHTML::_('grid.sort',   JText::_('User Name'), 'juser.username', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
				<th><?php echo JHTML::_('grid.sort', JText::_('Enabled'), 'juser.block', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
				<th><?php echo JHTML::_('grid.sort',   JText::_('Group'), 'juser.usertype', @$this->lists['order_Dir'], @$this->lists['order'] ); ?></th>
