<?php
/**
 * @version		$Id: default.php 318 2010-01-15 02:18:54Z joomlaworks $
 * @package		K2
		...
		<td>
		  ...
		  <fieldset class="adminform">
		    ...
		    <table class="adminlist">
		      ...
		      <tbody>
		        <tr>
		          <td><strong><?php echo JText::_('Simple Image Gallery Plugin');?></strong></td>
		          <td><?php 
						if (JFile::exists(JPATH_PLUGINS.DS.'content'.DS.'jw_sig.php'))
